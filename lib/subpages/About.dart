          ...
          children: <Widget>[
            ...
            Text(
              ("Number of moves:  ") +
                  ...
                  ("\n"),
              style: TextStyle(
                fontWeight: FontWeight.normal, fontSize: 18, color: Colors.white,),textAlign: TextAlign.center,
            ),
            Image.network(
            ...
            Padding(
                ...
                child: YoutubePlayer(source: "gZvn0B4JSLg", context: context, quality: YoutubeQuality.FHD)
            )
          ],
        ),
      ),
