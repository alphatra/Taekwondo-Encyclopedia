...
class Makgi extends StatefulWidget {
  @override
  _MakgiState createState() => _MakgiState();
}
  ...
  initiateSearch(value) {
    ...
    if (queryResultSet.length == 0 && value.length == 1) {
      ...
      queryResultSet.forEach((element) {
        if (element['Block'].startsWith(capitalizedValue)) {
          setState(() {
...
class _ListPageState extends State<ListPage> {
  Future getPosts() async {
    QuerySnapshot qn =
    await Firestore.instance.collection('Blocks').getDocuments();
    return qn.documents;
  }
                    ...
                    return Padding(
                      ...
                      child: GestureDetector(
                        ...
                        child: RichText(
                          textAlign: TextAlign.start,
                          text: TextSpan(
                            text: (snapshot.data[index]['Block']) + "\n",
                            style: textfirst,
                            children: <TextSpan>[
                              TextSpan(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        ...
        child: Column(
          children: <Widget>[
            Navbar(magia:  widget.post.data['Block'],),
            Text(
              widget.post.data['Block'],
              style: textfirst,
            ),
            Text(
